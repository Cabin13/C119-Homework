...
var sketch= quick_draw_data_set.index(randomNumber)
console.log(sketch)
document.getElementById("whatToDraw").innerHTML= sketch
}
...
function gotResult(error, result) {
    if (error) {
        ...
        console.log(result)
        drawnSketch= result[0]
        document.getElementById("sketchGuess").innerHTML= drawnSketch
        document.getElementById("sketchConfidence").innerHTML= Math.floor(result[0].confidence*100) + "%"
    }
}
